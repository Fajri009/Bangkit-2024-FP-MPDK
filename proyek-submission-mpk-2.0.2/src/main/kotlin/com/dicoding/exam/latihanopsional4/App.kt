...
fun getMiddleCharacters(string: String): String {
    val splitLength = string.length / 2
    var result = ""
    if (string.length % 2 != 0) {
        result = string[splitLength].toString()
    } else {
        val midChar1 = string[splitLength - 1].toString()
        val midChar2 = string[splitLength].toString()
        result = midChar1 + midChar2
    }
    return result
}
